...
/**
 * /settings/account — mirrors the AccountSection layout:
 * - Change Password card (3 fields + button)
 * - Change Email card (1 field + button)
 * - Delete Account danger card
 */
export default function AccountSettingsLoading() {
  return (
    <SettingsShellSkeleton>
      <SettingsPageSkeleton title="Account" description="Update login credentials and manage account actions.">
        <SettingsCard>
