...
/**
 * /settings/company — mirrors the CompanyInfoForm layout:
 * - One card with logo placeholder + multi-column fields
 * - Address / city-state-zip / license-insurance rows
 * - Brand color row + save button
 */
