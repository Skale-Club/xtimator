...
export default async function AuthLayout({
  ...
  return (
    <div
      ...
      style={style}
      className="relative isolate flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-4 py-12 text-foreground selection:bg-primary/30"
    >
