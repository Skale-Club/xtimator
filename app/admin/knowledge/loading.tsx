  ...
  return (
    <AdminShellSkeleton>
      <div className="space-y-8">
        ...
        <Skeleton className="h-40 w-full animate-pulse bg-[var(--glass-bg)] rounded-lg" />

        <div className="flex flex-col gap-2">
          {Array.from({ length: 5 }).map((_, i) => (
            <div
              key={i}
              className="flex items-center gap-4 rounded-lg border p-3 animate-pulse bg-[var(--glass-bg)]"
            >
