...
// PUI-02 (v4.11) / 260705-8u0-02 — structural assertion of the Modern PDF template's totals
// block, mirroring tests/unit/pdf/estimate-pdf-totals.test.tsx (Classic) but importing
// EstimatePDFModern. Proves Modern's restyle keeps 100% of the DATA LOGIC identical to
// Classic: same values, same labels, same order — only StyleSheet/JSX differs.
//
// GUARD-03: the Deposit row value (-$300.00) is total − persisted balance_due, NOT a
// recompute from deposit_value. Test 3 proves Modern also trusts the persisted balance_due.
...
describe('EstimatePDFModern totals block — deposit / balance due (PUI-02)', () => {
