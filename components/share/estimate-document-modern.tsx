...
const DOC_LABELS: Record<EstimateLanguage, DocLabels> = {
  en: {
    estimate: 'ESTIMATE',
    project: 'Project',
    billTo: 'Bill To',
...
// ---------------------------------------------------------------------------
// Pure helpers — duplicated verbatim from estimate-document.tsx (small,
// self-contained; editing that file's exports is out of scope for this plan).
// ---------------------------------------------------------------------------
