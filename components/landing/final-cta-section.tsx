        ...
        >
          ...
          <div className="relative z-10 mt-4 flex shrink-0 flex-col gap-2 sm:mt-10 sm:flex-row sm:gap-4 lg:mt-0">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="h-9 text-sm px-3 font-semibold sm:h-14 sm:text-lg sm:px-6 border-white/10 bg-white/5 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:min-w-40"
            >
