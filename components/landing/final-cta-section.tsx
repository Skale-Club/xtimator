    ...
    <section className="relative bg-transparent py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-6 sm:px-8 lg:px-10">
        <motion.div 
          ...
          className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-black/40 px-6 py-16 shadow-[0_0_80px_hsl(var(--primary)/0.15)] backdrop-blur-md sm:px-12 sm:py-20 lg:flex lg:items-center lg:justify-between lg:gap-8"
        >
          {/* Background glows */}
          ...
          <div className="relative z-10 mt-10 flex shrink-0 flex-col gap-4 sm:flex-row lg:mt-0">
            <Button
              asChild
              size="lg"
              className="group h-14 bg-primary text-lg font-semibold text-primary-foreground shadow-[0_0_30px_hsl(var(--primary)/0.4)] transition-all hover:scale-105 hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:min-w-44"
            >
              <Link href="/signup">
                Create account
