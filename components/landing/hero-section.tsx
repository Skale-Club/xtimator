          ...
          >
            ...
            >
              ...
              <Button
                ...
                size="default"
                variant="outline"
                className="flex-1 sm:flex-none border-white/10 bg-white/5 font-semibold text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:w-auto sm:min-w-36 h-7 text-xs px-2.5 sm:h-10 sm:text-sm sm:px-4"
              >
