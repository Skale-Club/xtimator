 ...
 * viewing a company via the "View as Company" support session (SUPPORT-02;
 * renamed per 157-CONTEXT.md NAMING-02, internal names/files unchanged).
 * Mirrors DemoBanner's exact structure/classes — see
  ...
  return (
    <div className="flex items-center justify-center gap-2 border-b border-primary/20 bg-primary/10 px-4 py-2 text-sm text-foreground">
      ...
      <span className="text-center">
        Viewing <strong>{companyName}</strong> as {adminEmail}.{' '}
