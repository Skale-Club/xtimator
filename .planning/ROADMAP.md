...
**Plans**: 1 plan
Plans:
- [ ] 39-01-PLAN.md — proxy.ts custom host detection + EstimateView white-label prop + estimate page header wiring + unit tests
**UI hint**: yes
...
| 39. Subdomain Routing + White-label Estimate View | v1.9 | 0/1 | In progress | - |
