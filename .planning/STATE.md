...
Last activity: 2026-05-29 - Completed quick task 260529-jh7: Add UNIQUE (company_id) to company_whatsapp (fixes ON CONFLICT error breaking the WhatsApp connect flow)
