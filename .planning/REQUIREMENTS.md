...
- [x] **I18N-05**: Strings not found in the static dictionary are automatically translated by AI via `/api/translate` — requests are batched and debounced 50ms; translated strings are saved to the `translations` DB table with `onConflictDoNothing()`
...
| I18N-05 | i18n | Phase 12 | Complete |
