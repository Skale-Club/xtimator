...
- [x] **INBOX-08**: The Inbox Settings sub-page (`/admin/inbox/settings`, Accounts + Templates tables) receives the same glass-surface visual treatment for consistency with the redesigned main Inbox.
...
| INBOX-08 | Phase 159 — Inbox Visual Redesign | Complete |
