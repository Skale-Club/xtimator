...
| 81-01-02 | 01 | 0 | WA-SEND-06 | T-81-05 | `[BLOCKING]` supabase db push + smoke INSERT (channel='whatsapp', provider='meta') | manual checkpoint | `npx supabase db push` + smoke INSERT via Supabase MCP | manual checkpoint | ⬜ pending |
